...
export default function About() {
  ...
  <section class="breadcrumbs py-4" data-aos="fade-up" data-aos-delay="200">
    <div class="container">
      ...
      Хотя, заключительные этапы внутренней сети дают полное представление о
параметрах спекулятивной среды
            ...
            <div class="col-12 col-lg-6">
              ...
              <form class="main-form" id="contact-us-form" action="contact.php" method="post">
                <div class="col-12">
                  <div class="row g-3 mb-1">
                    <div class="col-lg-6 col-12" data-aos="fade-right" data-aos-delay="200">
                      <input placeholder="Имя" type="text" id="name" name="name" required class="text-input"/>
                    </div>
                    <div class="col-lg-6 col-12" data-aos="fade-left" data-aos-delay="200">
                      <input placeholder="Тема" type="text" id="subject" name="subject" required class="text-input"/>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12" data-aos="fade-up" data-aos-delay="300">
                  <textarea placeholder="Сообщение" class="text-input my-2" rows="7" cols="30" id="message" name="message"
                    required></textarea>
                </div>
